...
test("GitHub skill sources require an exact canonical file path and are never silently normalized", () => {
  ...
  const invalid = [
    ...
    "https://github.com/NousResearch/hermes-agent/issues/123",
    "https://github.com/NousResearch/hermes-agent/pull/456",
    "https://github.com/NousResearch/hermes-agent/blob/main/README.md",
    "https://github.com/NousResearch/hermes-agent/blob/main/SKILL.md",
    "https://github.com/NousResearch/hermes-agent/blob/main/skills/research/grounded-citations",
    "https://github.com/NousResearch/hermes-agent/tree/main/skills/research/grounded-citations/SKILL.md",
    "https://github.com/NousResearch/hermes-agent/blob/-unsafe/skills/research/grounded-citations/SKILL.md",
    "https://github.com/Nous--Research/hermes-agent/blob/main/skills/research/grounded-citations/SKILL.md",
